...
### Console output without line numbers :penguin:
...
<input type="checkbox" id="jyutping-toggle" name="jyutping-toggle" />
<label for="jyutping-toggle">Show Jyutping ruby</label>
